...
class update_today_deal extends StatefulWidget {
  final String? img;
  final String? name;
  final String? price;
  ...
  @override
  _update_today_dealState createState() => _update_today_dealState();
}

class _update_today_dealState extends State<update_today_deal> {
  String? name;
  String? price;
