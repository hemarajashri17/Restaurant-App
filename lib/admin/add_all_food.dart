...
class add_allFood extends StatefulWidget {
  const add_allFood({Key? key}) : super(key: key);

  @override
  _add_allFoodState createState() => _add_allFoodState();
}

class _add_allFoodState extends State<add_allFood> {
  String? name;
  String? price;
  ...
  Future uploadFile() async {
    ...
    final destination = 'allFood/$fileName';
  ...
  Future<String?> _Upload() async {
    try {
      DocumentReference doc_ref =
          FirebaseFirestore.instance.collection("allFood").doc();
