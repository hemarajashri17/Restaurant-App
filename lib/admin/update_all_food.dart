...
class update_all_food extends StatefulWidget {
  final String? img;
  final String? name;
  final String? price;
  ...
  @override
  _update_all_foodState createState() => _update_all_foodState();
}

class _update_all_foodState extends State<update_all_food> {
  String? name;
  String? price;
